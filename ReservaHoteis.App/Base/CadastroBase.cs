...
namespace ReservaHoteis.App.Base
{
    public partial class CadastroBase : MaterialForm
    {
        ...
        {
            if (MessageBox.Show(@"Deseja realmente cancelar?", @"Reserva Hoteis", MessageBoxButtons.YesNo,
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(@"Deseja realmente deletar?", @"Reserva Hoteis", MessageBoxButtons.YesNo,
                        MessageBoxIcon.Question)
                    == DialogResult.Yes)
                {
            ...
            {
                MessageBox.Show(@"Selecione algum registro!", @"Reserva Hoteis", MessageBoxButtons.OK,
